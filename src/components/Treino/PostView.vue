    ...
    <div class="mdl-grid">
      ...
      <div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-dirty">
          ...
          <label for="username" class="mdl-textfield__label">Descreve-me</label>
        </div>
        <div class="actions">
        ...
        <router-link class="picture-button mdl-button mdl-js-button mdl-button--fab mdl-button--colored" to="/treino">
