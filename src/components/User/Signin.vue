          ...
          <v-card-text>
            <v-container>
              <form @submit.prevent="onSignin">
                ...
                <v-layout align-end >
<!-- button facebook -->
                    <v-btn  color="light-blue darken-4" dark :disabled="loading" :loading="loading" @click.prevent="onSigninFacebook">
                ...
                <v-layout align-end justify-start >
                    <v-flex xs12 md3>
<!-- button twitter -->
                      <v-btn  color="info" dark :disabled="loading" :loading="loading" @click.prevent="onSigninTwitter">
                          ...
                          <svg width="24px" height="24px" viewBox="0 0 120 98" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>Entrar com o twitter</title>
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                 ...
                 <v-layout align-end justify-start >
                    <v-flex xs12 md3>
<!-- button google -->
                      <v-btn  color="white" dark :disabled="loading" :loading="loading" @click.prevent="onSigninGoogle">
